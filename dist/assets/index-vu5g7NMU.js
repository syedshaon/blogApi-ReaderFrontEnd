...
var j = Iu.exports;
const Bu = Fp(j),
  tm = Mp({ __proto__: null, default: Bu }, [j]);
/**
 * @license React
 ...
 */ (function (e) {
  ...
  (e.unstable_IdlePriority = 5),
    ...
    (e.unstable_scheduleCallback = function (b, R, L) {
      ...
      return (te = L + te), (b = { id: f++, callback: R, priorityLevel: b, startTime: L, expirationTime: te, sortIndex: -1 }), L > X ? ((b.sortIndex = L), t(u, b), r(a) === null && b === r(u) && (v ? (h(O), (O = -1)) : (v = !0), Qo(S, L - X))) : ((b.sortIndex = te), t(a, b), x || g || ((x = !0), Ho(C))), b;
    }),
...
function Pm(e) {
  if (Ze && typeof Ze.onCommitFiberRoot == "function")
    try {
      Ze.onCommitFiberRoot(oo, e, void 0, (e.current.flags & 128) === 128);
    } catch {}
}
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var m = u, y; m !== null; ) {
          y = m;
          var S = y.stateNode;
          if ((y.tag === 5 && S !== null && ((y = S), h !== null && ((S = gn(m, h)), S != null && v.push(Nn(m, S, y)))), w)) break;
          m = m.return;
        }
        0 < v.length && ((p = new g(p, x, null, r, f)), d.push({ event: p, listeners: v }));
      }
    }
    if (!(t & 7)) {
      e: {
        if (((p = e === "mouseover" || e === "pointerover"), (g = e === "mouseout" || e === "pointerout"), p && r !== Qi && (x = r.relatedTarget || r.fromElement) && (Yt(x) || x[st]))) break e;
        if ((g || p) && ((p = f.window === f ? f : (p = f.ownerDocument) ? p.defaultView || p.parentWindow : window), g ? ((x = r.relatedTarget || r.toElement), (g = u), (x = x ? Yt(x) : null), x !== null && ((w = cr(x)), x !== w || (x.tag !== 5 && x.tag !== 6)) && (x = null)) : ((g = null), (x = u)), g !== x)) {
          if (((v = ua), (S = "onMouseLeave"), (h = "onMouseEnter"), (m = "mouse"), (e === "pointerout" || e === "pointerover") && ((v = da), (S = "onPointerLeave"), (h = "onPointerEnter"), (m = "pointer")), (w = g == null ? p : xr(g)), (y = x == null ? p : xr(x)), (p = new v(S, m + "leave", g, r, f)), (p.target = w), (p.relatedTarget = y), (S = null), Yt(f) === u && ((v = new v(h, m + "enter", x, r, f)), (v.target = y), (v.relatedTarget = w), (S = v)), (w = S), g && x))
            t: {
              for (v = g, h = x, m = 0, y = v; y; y = ar(y)) m++;
              for (y = 0, S = h; S; S = ar(S)) y++;
              for (; 0 < m - y; ) (v = ar(v)), m--;
              for (; 0 < y - m; ) (h = ar(h)), y--;
              for (; m--; ) {
          ...
          g !== null && ka(d, p, g, v, !1), x !== null && w !== null && ka(d, w, x, v, !0);
        }
      }
      e: {
        if (((p = u ? xr(u) : window), (g = p.nodeName && p.nodeName.toLowerCase()), g === "select" || (g === "input" && p.type === "file"))) var C = ph;
        else if (ha(p))
          if (Tf) C = yh;
          else {
            C = hh;
        ...
        else (g = p.nodeName) && g.toLowerCase() === "input" && (p.type === "checkbox" || p.type === "radio") && (C = xh);
        if (C && (C = C(e, u))) {
          Of(d, C, r, f);
          break e;
        }
  ...
  if (i !== null) {
    ...
    do {
      var p = s.lane,
        g = s.eventTime;
      if ((n & p) === p) {
        f !== null && (f = f.next = { eventTime: g, lane: 0, tag: s.tag, payload: s.payload, callback: s.callback, next: null });
        e: {
          var x = e,
            v = s;
          switch (((p = t), (g = r), v.tag)) {
            case 1:
            ...
            case 0:
              if (((x = v.payload), (p = typeof x == "function" ? x.call(g, d, p) : x), p == null)) break e;
              d = K({}, d, p);
              break e;
            case 2:
              ht = !0;
      ...
      } else (g = { eventTime: g, lane: p, tag: s.tag, payload: s.payload, callback: s.callback, next: null }), f === null ? ((u = f = g), (a = d)) : (f = f.next = g), (c |= p);
      if (((s = s.next), s === null)) {
...
function Zf(e) {
  ...
  function s(h, m, y, S) {
    return m === null || m.tag !== 6 ? ((m = vi(y, h.mode, S)), (m.return = h), m) : ((m = l(m, y)), (m.return = h), m);
  }
  function a(h, m, y, S) {
    var C = y.type;
    return C === dr ? f(h, m, y.props.children, S, y.key) : m !== null && (m.elementType === C || (typeof C == "object" && C !== null && C.$$typeof === mt && za(C) === m.type)) ? ((S = l(m, y.props)), (S.ref = Zr(h, m, y)), (S.return = h), S) : ((S = kl(y.type, y.key, y.props, null, h.mode, S)), (S.ref = Zr(h, m, y)), (S.return = h), S);
  }
  function u(h, m, y, S) {
    return m === null || m.tag !== 4 || m.stateNode.containerInfo !== y.containerInfo || m.stateNode.implementation !== y.implementation ? ((m = gi(y, h.mode, S)), (m.return = h), m) : ((m = l(m, y.children || [])), (m.return = h), m);
  }
  function f(h, m, y, S, C) {
    return m === null || m.tag !== 7 ? ((m = qt(y, h.mode, S, C)), (m.return = h), m) : ((m = l(m, y)), (m.return = h), m);
  }
  function d(h, m, y) {
    if ((typeof m == "string" && m !== "") || typeof m == "number") return (m = vi("" + m, h.mode, y)), (m.return = h), m;
    if (typeof m == "object" && m !== null) {
      switch (m.$$typeof) {
        case Xn:
          return (y = kl(m.type, m.key, m.props, null, h.mode, y)), (y.ref = Zr(h, null, m)), (y.return = h), y;
        case fr:
          return (m = gi(m, h.mode, y)), (m.return = h), m;
        case mt:
          var S = m._init;
          return d(h, S(m._payload), y);
      }
      if (nn(m) || Kr(m)) return (m = qt(m, h.mode, y, null)), (m.return = h), m;
      cl(h, m);
    }
    return null;
  }
  function p(h, m, y, S) {
    ...
    if ((typeof y == "string" && y !== "") || typeof y == "number") return C !== null ? null : s(h, m, "" + y, S);
    if (typeof y == "object" && y !== null) {
      ...
      if (nn(y) || Kr(y)) return C !== null ? null : f(h, m, y, S, null);
      cl(h, y);
    }
    return null;
  }
  function g(h, m, y, S, C) {
    if ((typeof S == "string" && S !== "") || typeof S == "number") return (h = h.get(y) || null), s(m, h, "" + S, C);
    if (typeof S == "object" && S !== null) {
      switch (S.$$typeof) {
        ...
        case mt:
          var P = S._init;
          return g(h, m, y, P(S._payload), C);
      }
      if (nn(S) || Kr(S)) return (h = h.get(y) || null), f(m, h, S, C, null);
      cl(m, S);
    }
    return null;
  }
  function x(h, m, y, S) {
    for (var C = null, P = null, N = m, O = (m = 0), D = null; N !== null && O < y.length; O++) {
      ...
      e && N && T.alternate === null && t(h, N), (m = i(T, m, O)), P === null ? (C = T) : (P.sibling = T), (P = T), (N = D);
    }
    if (O === y.length) return r(h, N), V && Qt(h, O), C;
    if (N === null) {
      for (; O < y.length; O++) (N = d(h, y[O], S)), N !== null && ((m = i(N, m, O)), P === null ? (C = N) : (P.sibling = N), (P = N));
      return V && Qt(h, O), C;
    }
    for (N = n(h, N); O < y.length; O++) (D = g(N, h, O, y[O], S)), D !== null && (e && D.alternate !== null && N.delete(D.key === null ? O : D.key), (m = i(D, m, O)), P === null ? (C = D) : (P.sibling = D), (P = D));
    return (
      e &&
  ...
  function v(h, m, y, S) {
    ...
    for (var P = (C = null), N = m, O = (m = 0), D = null, T = y.next(); N !== null && !T.done; O++, T = y.next()) {
      N.index > O ? ((D = N), (N = null)) : (D = N.sibling);
      var oe = p(h, N, T.value, S);
      if (oe === null) {
        N === null && (N = D);
        break;
      }
      e && N && oe.alternate === null && t(h, N), (m = i(oe, m, O)), P === null ? (C = oe) : (P.sibling = oe), (P = oe), (N = D);
    }
    if (T.done) return r(h, N), V && Qt(h, O), C;
    if (N === null) {
      for (; !T.done; O++, T = y.next()) (T = d(h, T.value, S)), T !== null && ((m = i(T, m, O)), P === null ? (C = T) : (P.sibling = T), (P = T));
      return V && Qt(h, O), C;
    }
    for (N = n(h, N); !T.done; O++, T = y.next()) (T = g(N, h, O, T.value, S)), T !== null && (e && T.alternate !== null && N.delete(T.key === null ? O : T.key), (m = i(T, m, O)), P === null ? (C = T) : (P.sibling = T), (P = T));
    return (
      e &&
          ...
          e: {
            for (var C = y.key, P = m; P !== null; ) {
              if (P.key === C) {
                if (((C = y.type), C === dr)) {
                  if (P.tag === 7) {
                    r(h, P.sibling), (m = l(P, y.props.children)), (m.return = h), (h = m);
                    break e;
                  }
                } else if (P.elementType === C || (typeof C == "object" && C !== null && C.$$typeof === mt && za(C) === P.type)) {
                  r(h, P.sibling), (m = l(P, y.props)), (m.ref = Zr(h, P, y)), (m.return = h), (h = m);
                  break e;
                }
                r(h, P);
                break;
            ...
            y.type === dr ? ((m = qt(y.props.children, h.mode, S, y.key)), (m.return = h), (h = m)) : ((S = kl(y.type, y.key, y.props, null, h.mode, S)), (S.ref = Zr(h, m, y)), (S.return = h), (h = S));
          }
          return c(h);
        case fr:
          e: {
            for (P = y.key; m !== null; ) {
              if (m.key === P)
                if (m.tag === 4 && m.stateNode.containerInfo === y.containerInfo && m.stateNode.implementation === y.implementation) {
                  r(h, m.sibling), (m = l(m, y.children || [])), (m.return = h), (h = m);
                  break e;
                } else {
                  r(h, m);
                  break;
            ...
            (m = gi(y, h.mode, S)), (m.return = h), (h = m);
          }
          return c(h);
        case mt:
          return (P = y._init), w(h, m, P(y._payload), S);
      }
      if (nn(y)) return x(h, m, y, S);
      if (Kr(y)) return v(h, m, y, S);
      cl(h, y);
    }
    return (typeof y == "string" && y !== "") || typeof y == "number" ? ((y = "" + y), m !== null && m.tag === 6 ? (r(h, m.sibling), (m = l(m, y)), (m.return = h), (h = m)) : (r(h, m), (m = vi(y, h.mode, S)), (m.return = h), (h = m)), c(h)) : r(h, m);
  }
  return w;
}
var Ir = Zf(!0),
...
function ds(e, t) {
  switch ((A(bn, t), A(_n, e), A(qe, Wn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
var Bl = { readContext: ze, useCallback: ae, useContext: ae, useEffect: ae, useImperativeHandle: ae, useInsertionEffect: ae, useLayoutEffect: ae, useMemo: ae, useReducer: ae, useRef: ae, useState: ae, useDebugValue: ae, useDeferredValue: ae, useTransition: ae, useMutableSource: ae, useSyncExternalStore: ae, useId: ae, unstable_isNewReconciler: !1 },
  $h = {
    ...
    useTransition: function () {
      var e = Da(!1),
        t = e[0];
      return (e = Ih.bind(null, e[1])), (Xe().memoizedState = e), [t, e];
    },
...
function Wa(e, t, r, n, l) {
  ...
  if ((Pr(t, l), t.stateNode === null)) jl(e, t), Jf(t, r, n), fc(t, r, n, l), (n = !0);
    ...
    (f = typeof g == "function" || typeof c.getSnapshotBeforeUpdate == "function") || (typeof c.UNSAFE_componentWillReceiveProps != "function" && typeof c.componentWillReceiveProps != "function") || ((s !== d || p !== a) && Ia(t, c, n, a)), (ht = !1), (p = t.memoizedState), (c.state = p), Fl(t, n, c, l);
    var x = t.memoizedState;
    s !== d || p !== x || je.current || ht
      ? (typeof g == "function" && (uc(t, r, g, n), (x = t.memoizedState)),
  ...
  switch ((os(t), t.tag)) {
    ...
    case 5:
      ...
      if (((r = t.type), e !== null && t.stateNode != null)) bd(e, t, r, n, l), e.ref !== t.ref && ((t.flags |= 512), (t.flags |= 2097152));
        ...
        if (((e = Jt(qe.current)), il(t))) {
          (n = t.stateNode), (r = t.type);
          var i = t.memoizedProps;
          switch (((n[Je] = t), (n[Pn] = i), (e = (t.mode & 1) !== 0), r)) {
            case "dialog":
    ...
    case 6:
      if (e && t.stateNode != null) Od(e, t, e.memoizedProps, n);
        ...
        if (((r = Jt(bn.current)), Jt(qe.current), il(t))) {
          if (((n = t.stateNode), (r = t.memoizedProps), (n[Je] = t), (i = n.nodeValue !== r) && ((e = Ce), e !== null)))
            switch (e.tag) {
              case 3:
          ...
          i && (t.flags |= 4);
        } else (n = (r.nodeType === 9 ? r : r.ownerDocument).createTextNode(n)), (n[Je] = t), (t.stateNode = n);
      }
      return ue(t), null;
    case 13:
      ...
      e: {
        ...
        if (n && n.rangeCount !== 0) {
          ...
          var c = 0,
            ...
            p = null;
          t: for (;;) {
            for (var g; d !== r || (l !== 0 && d.nodeType !== 3) || (s = c + l), d !== i || (n !== 0 && d.nodeType !== 3) || (a = c + n), d.nodeType === 3 && (c += d.nodeValue.length), (g = d.firstChild) !== null; ) (p = d), (d = g);
            for (;;) {
              if (d === e) break t;
              if ((p === r && ++u === l && (s = c), p === i && ++f === n && (a = c), (g = d.nextSibling) !== null)) break;
              (d = p), (p = d.parentNode);
            }
            d = g;
          }
              ...
              case 1:
                if (x !== null) {
                  var v = x.memoizedProps,
                    w = x.memoizedState,
                    h = t.stateNode,
                    m = h.getSnapshotBeforeUpdate(t.elementType === t.type ? v : Fe(t.type, v), w);
...
function Td(e) {
  var t = e.alternate;
  t !== null && ((e.alternate = null), Td(t)), (e.child = null), (e.deletions = null), (e.sibling = null), e.tag === 5 && ((t = e.stateNode), t !== null && (delete t[Je], delete t[Pn], delete t[oc], delete t[bh], delete t[Oh])), (e.stateNode = null), (e.return = null), (e.dependencies = null), (e.memoizedProps = null), (e.memoizedState = null), (e.pendingProps = null), (e.stateNode = null), (e.updateQueue = null);
}
function Rd(e) {
...
function Id(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Me(t, e), Ke(e), n & 512 && r !== null && wr(r, r.return);
      break;
    case 5:
      if ((Me(t, e), Ke(e), n & 512 && r !== null && wr(r, r.return), e.flags & 32)) {
        var l = e.stateNode;
        try {
          vn(l, "");
        } catch (v) {
          ...
          try {
            ...
            switch (s) {
              ...
              case "select":
                ...
                var g = i.value;
                g != null ? kr(l, !!i.multiple, g, !1) : p !== !!i.multiple && (i.defaultValue != null ? kr(l, !!i.multiple, i.defaultValue, !0) : kr(l, !!i.multiple, i.multiple ? [] : "", !1));
            }
            l[Pn] = i;
          } catch (v) {
            G(e, e.return, v);
    ...
    case 6:
      ...
      break;
    case 3:
      if ((Me(t, e), Ke(e), n & 4 && r !== null && r.memoizedState.isDehydrated))
        try {
          Sn(t.containerInfo);
        } catch (v) {
          G(e, e.return, v);
    ...
    case 4:
      ...
      break;
    case 13:
      Me(t, e), Ke(e), (l = e.child), l.flags & 8192 && ((i = l.memoizedState !== null), (l.stateNode.isHidden = i), !i || (l.alternate !== null && l.alternate.memoizedState !== null) || (ks = J())), n & 4 && Ga(e);
      break;
    case 22:
      if (((f = r !== null && r.memoizedState !== null), e.mode & 1 ? ((de = (u = de) || f), Me(t, e), (de = u)) : Me(t, e), Ke(e), n & 8192)) {
    ...
    try {
      ...
      e: {
        ...
        if (((t = ce), (s.flags |= 32768), a !== null && typeof a == "object" && typeof a.then == "function")) {
          ...
          var g = Fa(c);
          if (g !== null) {
            (g.flags &= -257), Aa(g, c, s, i, t), g.mode & 1 && Ma(i, u, t), (t = g), (a = u);
            var x = t.updateQueue;
            if (x === null) {
              var v = new Set();
          ...
          var w = Fa(c);
          if (w !== null) {
            !(w.flags & 65536) && (w.flags |= 256), Aa(w, c, s, i, t), is(Dr(a, s));
            break e;
          }
        }
        ...
        do {
          switch (i.tag) {
            ...
            case 1:
              ...
              var m = i.type,
                y = i.stateNode;
              if (!(i.flags & 128) && (typeof m.getDerivedStateFromError == "function" || (y !== null && typeof y.componentDidCatch == "function" && (_t === null || !_t.has(y))))) {
                (i.flags |= 65536), (t &= -t), (i.lanes |= t);
                var S = wd(i, s, t);
                Ta(i, S);
                break e;
  ...
  if (jt !== null) {
    ...
    try {
      if (((Ie.transition = null), ($ = 16 > e ? 16 : e), jt === null)) var n = !1;
        ...
        if (((z = l), At(), Ze && typeof Ze.onPostCommitFiberRoot == "function"))
          try {
            Ze.onPostCommitFiberRoot(oo, e);
          } catch {}
        n = !0;
      }
      return n;
...
function px(e, t, r, n) {
  ...
  function d() {
    ...
    let w = f(),
      h = w == null ? null : w - u;
    (u = w), a && a({ action: s, location: v.location, delta: h });
  }
  function p(w, h) {
    s = wt.Push;
    let m = Nc(v.location, w, h);
    r && r(m, w), (u = f() + 1);
    let y = lu(m, u),
      S = v.createHref(m);
    try {
  ...
  function g(w, h) {
    ...
    let y = lu(m, u),
      S = v.createHref(m);
    c.replaceState(y, "", S), i && a && a({ action: s, location: v.location, delta: 0 });
  }
  function x(w) {
    let h = l.location.origin !== "null" ? l.location.origin : l.location.href,
      m = typeof w == "string" ? w : Gl(w);
    return Y(h, "No window.location.(origin|href) available to create URL for href: " + m), new URL(m, h);
  }
  let v = {
    get action() {
      return s;
...
function Pc(e, t) {
  ...
  return {
    params: n.reduce((u, f, d) => {
      let { paramName: p, isOptional: g } = f;
      if (p === "*") {
        let v = s[d] || "";
        c = i.slice(0, i.length - v.length).replace(/(.)\/+$/, "$1");
      }
      const x = s[d];
      return g && !x ? (u[p] = void 0) : (u[p] = Px(x || "", p)), u;
    }, {}),
    pathname: i,
    pathnameBase: c,
    pattern: e,
...
const wo = j.createContext(null),
  ep = j.createContext(null),
  sr = j.createContext(null),
  So = j.createContext(null),
  Ut = j.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
  tp = j.createContext(null);
function zx(e, t) {
  let { relative: r } = t === void 0 ? {} : t;
  Vn() || Y(!1);
  let { basename: n, navigator: l } = j.useContext(sr),
    { hash: i, pathname: c, search: s } = ko(e, { relative: r }),
    a = c;
  return n !== "/" && (a = c === "/" ? n : Tt([n, c])), l.createHref({ pathname: a, search: s, hash: i });
}
function Vn() {
  return j.useContext(So) != null;
}
function Hn() {
  return Vn() || Y(!1), j.useContext(So).location;
}
function rp(e) {
  j.useContext(sr).static || j.useLayoutEffect(e);
}
function tt() {
  let { isDataRoute: e } = j.useContext(Ut);
  return e ? Gx() : Dx();
}
function Dx() {
  Vn() || Y(!1);
  let e = j.useContext(wo),
    { basename: t, navigator: r } = j.useContext(sr),
    { matches: n } = j.useContext(Ut),
    { pathname: l } = Hn(),
...
function ko(e, t) {
  ...
  return j.useMemo(() => Zd(e, JSON.parse(i), l, r === "path"), [e, i, l, r]);
}
function $x(e, t) {
  return Mx(e, t);
}
function Mx(e, t, r) {
  Vn() || Y(!1);
  let { navigator: n } = j.useContext(sr),
    { matches: l } = j.useContext(Ut),
    i = l[l.length - 1],
    c = i ? i.params : {};
  i && i.pathname;
  ...
  if (t) {
    var f;
    let v = typeof t == "string" ? Wr(t) : t;
    s === "/" || ((f = v.pathname) != null && f.startsWith(s)) || Y(!1), (u = v);
  } else u = a;
  let d = u.pathname || "/",
    p = s === "/" ? d : d.slice(s.length) || "/",
    g = mx(e, { pathname: p }),
    x = Wx(g && g.map((v) => Object.assign({}, v, { params: Object.assign({}, c, v.params), pathname: Tt([s, n.encodeLocation ? n.encodeLocation(v.pathname).pathname : v.pathname]), pathnameBase: v.pathnameBase === "/" ? s : Tt([s, n.encodeLocation ? n.encodeLocation(v.pathnameBase).pathname : v.pathnameBase]) })), l, r);
  return t && x ? j.createElement(So.Provider, { value: { location: Yl({ pathname: "/", search: "", hash: "", state: null, key: "default" }, u), navigationType: wt.Pop } }, x) : x;
}
function Fx() {
  let e = Kx(),
    ...
    i = null;
  return j.createElement(j.Fragment, null, j.createElement("h2", null, "Unexpected Application Error!"), j.createElement("h3", { style: { fontStyle: "italic" } }, t), r ? j.createElement("pre", { style: l }, r) : null, i);
}
const Ax = j.createElement(Fx, null);
class Ux extends j.Component {
  constructor(t) {
  ...
  render() {
    return this.state.error ? j.createElement(Ut.Provider, { value: this.props.routeContext }, j.createElement(tp.Provider, { value: this.state.error, children: this.props.component })) : this.props.children;
  }
}
function Bx(e) {
  let { routeContext: t, match: r, children: n } = e,
    l = j.useContext(wo);
  return l && l.static && l.staticContext && (r.route.errorElement || r.route.ErrorBoundary) && (l.staticContext._deepestRenderedBoundaryId = r.route.id), j.createElement(Ut.Provider, { value: t }, n);
}
function Wx(e, t, r) {
  var n;
  ...
  return i.reduceRight((s, a, u) => {
    ...
    let p = t.concat(i.slice(0, u + 1)),
      g = () => {
        let x;
        return f ? (x = d) : a.route.Component ? (x = j.createElement(a.route.Component, null)) : a.route.element ? (x = a.route.element) : (x = s), j.createElement(Bx, { match: a, routeContext: { outlet: s, matches: p, isDataRoute: r != null }, children: x });
      };
    return r && (a.route.ErrorBoundary || a.route.errorElement || u === 0) ? j.createElement(Ux, { location: r.location, revalidation: r.revalidation, component: d, error: f, children: g(), routeContext: { outlet: null, matches: p, isDataRoute: !0 } }) : g();
  }, null);
}
var np = (function (e) {
...
function Hx(e) {
  let t = j.useContext(ep);
  return t || Y(!1), t;
}
function Qx(e) {
  let t = j.useContext(Ut);
  return t || Y(!1), t;
}
function lp(e) {
  let t = Qx(),
...
function Yx(e) {
  ...
  Vn() && Y(!1);
  let s = t.replace(/^\/*/, "/"),
    a = j.useMemo(() => ({ basename: s, navigator: i, static: c }), [s, i, c]);
  typeof n == "string" && (n = Wr(n));
  let { pathname: u = "/", search: f = "", hash: d = "", state: p = null, key: g = "default" } = n,
    x = j.useMemo(() => {
      let v = zn(u, s);
      return v == null ? null : { location: { pathname: v, search: f, hash: d, state: p, key: g }, navigationType: l };
    }, [s, u, f, d, p, g, l]);
  return x == null ? null : j.createElement(sr.Provider, { value: a }, j.createElement(So.Provider, { children: r, value: x }));
}
function Xx(e) {
...
function _c(e, t) {
  ...
  return (
    j.Children.forEach(e, (n, l) => {
      ...
      n.type !== Ge && Y(!1), !n.props.index || !n.props.children || Y(!1);
...
const qx = ["onClick", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "unstable_viewTransition"],
  ...
  ty = j.createContext({ isTransitioning: !1 }),
  ry = "startTransition",
  cu = tm[ry];
function ny(e) {
  ...
  let c = i.current,
    [s, a] = j.useState({ action: c.action, location: c.location }),
  ...
  return j.useLayoutEffect(() => c.listen(f), [c, f]), j.createElement(Yx, { basename: t, children: r, location: s.location, navigationType: s.action, navigator: c });
}
const ly = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u",
  oy = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  iy = j.forwardRef(function (t, r) {
    ...
    let w = zx(u, { relative: l }),
      h = sy(u, { replace: c, state: s, target: a, preventScrollReset: f, relative: l, unstable_viewTransition: d });
    function m(y) {
      n && n(y), y.defaultPrevented || h(y);
    }
    return j.createElement("a", Jl({}, p, { href: x || w, onClick: v || i ? n : m, ref: r, target: a }));
  }),
  Ye = j.forwardRef(function (t, r) {
    ...
    l || ((m = m.toLowerCase()), (y = y ? y.toLowerCase() : null), (h = h.toLowerCase()));
    const S = h !== "/" && h.endsWith("/") ? h.length - 1 : h.length;
    let C = m === h || (!c && m.startsWith(h) && m.charAt(S) === "/"),
      P = y != null && (y === h || (!c && y.startsWith(h) && y.charAt(h.length) === "/")),
      N = { isActive: C, isPending: P, isTransitioning: w },
      O = C ? n : void 0,
      D;
    typeof i == "function" ? (D = i(N)) : (D = [i, C ? "active" : null, P ? "pending" : null, w ? "transitioning" : null].filter(Boolean).join(" "));
    let T = typeof s == "function" ? s(N) : s;
    return j.createElement(iy, Jl({}, d, { "aria-current": O, className: D, ref: r, style: T, to: a, unstable_viewTransition: u }), typeof f == "function" ? f(N) : f);
  });
var bc;
(function (e) {
...
ap.useSyncExternalStoreWithSelector = function (e, t, r, n, l) {
  ...
  i = Ny(
    function () {
      function a(g) {
        if (!u) {
          if (((u = !0), (f = g), (g = n(g)), l !== void 0 && c.hasValue)) {
            var x = c.value;
            if (l(x, g)) return (d = x);
          }
          return (d = g);
        }
        if (((x = d), Sy(f, g))) return x;
        var v = n(g);
        return l !== void 0 && l(x, v) ? x : ((f = g), (d = v));
      }
      var u = !1,
        f,
        d,
...
function Dy(e = Dt) {
  ...
  return function (n, l = {}) {
    ...
    const g = j.useCallback(
      ...
      x = dp(u.addNestedSub, a.getState, f || a.getState, g, i);
...
function Gy(e, t) {
  ...
  const x = { addNestedSub: c, notifyNestedSubs: s, handleChangeWrapper: a, isSubscribed: u, trySubscribe: p, tryUnsubscribe: g, getListeners: () => n };
  return x;
}
const Yy = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u",
  Xy = Yy ? j.useLayoutEffect : j.useEffect;
function Jy({ store: e, context: t, children: r, serverState: n, stabilityCheck: l = "once", noopCheck: i = "once" }) {
  ...
  const a = t || Dt;
  return j.createElement(a.Provider, { value: c }, r);
}
function vp(e = Dt) {
  const t = e === Dt ? fp : Is(e);
  return function () {
...
function ki(e, t) {
  ...
  var r = t.p[0],
    n = e !== void 0 && e !== r;
  return t.h.O || et("ES5").S(t, e, n), n ? (r[W].P && (Zl(t), Be(4)), ft(e) && ((e = ql(t, e)), t.l || eo(t, e)), t.u && et("Patches").M(r[W].t, e, t.u, t.s)) : (e = ql(t, r, [])), Zl(t), t.u && t.v(t.u, t.s), e !== wp ? e : void 0;
}
function ql(e, t, r) {
  if (Vs(t)) return t;
  var n = t[W];
  ...
  if (!n.I) {
    ...
    n.i === 3 && ((i = new Set(l)), l.clear(), (c = !0)),
      ...
      eo(e, l, !1),
      r && e.u && et("Patches").N(n, r, e.u, e.s);
  }
  return n.o;
}
  ...
  return (
    ...
    (function t(r) {
      ...
      var n,
        ...
        i = Vr(r);
      if (l) {
        if (!l.P && (l.i < 4 || !et("ES5").K(l))) return l.t;
    ...
    J: function (i, c) {
      var s = Array.isArray(i),
        a = (function (f, d) {
          ...
          var x = Sp(d);
          delete x[W];
          for (var v = Or(x), w = 0; w < v.length; w++) {
            var h = v[w];
            ...
            (function a(u) {
              if (u && typeof u == "object") {
                ...
                if (f) {
                  ...
                  if (x === 4)
                    or(p, function (y) {
                      y !== W && (d[y] !== void 0 || br(d, y) ? g[y] || a(p[y]) : ((g[y] = !0), vt(f)));
                    }),
                      or(d, function (y) {
                        p[y] !== void 0 || br(p, y) || ((g[y] = !1), vt(f));
                      });
                  else if (x === 5) {
                    if ((n(f) && (vt(f), (g.length = !0)), p.length < d.length)) for (var v = p.length; v < d.length; v++) g[v] = !1;
                    else for (var w = d.length; w < p.length; w++) g[w] = !0;
                    for (var h = Math.min(p.length, d.length), m = 0; m < h; m++) p.hasOwnProperty(m) || (g[m] = !0), g[m] === void 0 && a(p[m]);
                  }
                }
              }
            })(i.p[0]),
        ...
        (this.produce = function (l, i, c) {
          if (typeof l == "function" && typeof i != "function") {
            ...
            return function (v) {
              var w = this;
              v === void 0 && (v = s);
              for (var h = arguments.length, m = Array(h > 1 ? h - 1 : 0), y = 1; y < h; y++) m[y - 1] = arguments[y];
              return a.produce(v, function (S) {
                var C;
                return (C = i).call.apply(C, [w, S].concat(m));
              });
            };
          }
          var u;
        ...
        (this.produceWithPatches = function (l, i) {
          if (typeof l == "function")
            return function (u) {
              ...
              return n.produceWithPatches(u, function (g) {
...
function Ep(e, t, r) {
  ...
  function p(v) {
    ...
    for (var w = (c = s), h = 0; h < w.length; h++) {
      var m = w[h];
      m();
    }
    return v;
    ...
    return (
      (v = {
        subscribe: function (m) {
          if (typeof m != "object" || m === null) throw new Error(fe(11));
          function y() {
            m.next && m.next(f());
          }
          y();
  ...
  return p({ type: to.INIT }), (n = { dispatch: p, subscribe: d, getState: f, replaceReducer: g }), (n[wu] = x), n;
}
function m0(e) {
  ...
  return function (a, u) {
    ...
    for (var f = !1, d = {}, p = 0; p < i.length; p++) {
      var g = i[p],
        ...
        v = a[g],
        w = x(v, u);
      if (typeof w > "u") throw (u && u.type, new Error(fe(14)));
      (d[g] = w), (f = f || w !== v);
    }
...
function R0(e) {
  ...
  var v = x0.apply(void 0, x),
    w = ro;
  a && (w = E0(Rt({ trace: !T0 }, typeof a == "object" && a)));
  var h = new P0(v),
    m = h;
  Array.isArray(p) ? (m = Fr([v], p)) : typeof p == "function" && (m = p(h));
...
function bp(e) {
  ...
  l.forEach(function (f) {
    var d = n[f],
      ...
      g,
      x;
    "reducer" in d ? ((g = d.reducer), (x = d.prepare)) : (g = d), (i[f] = g), (c[p] = g), (s[f] = x ? Lt(p, x) : Lt(p));
  });
  function a() {
    var f = typeof e.extraReducers == "function" ? _p(e.extraReducers) : [e.extraReducers],
      ...
      w = v === void 0 ? void 0 : v,
      h = Rt(Rt({}, p), c);
    return I0(r, function (m) {
      for (var y in h) m.addCase(y, h[y]);
      for (var S = 0, C = x; S < C.length; S++) {
        var P = C[S];
        m.addMatcher(P.matcher, P.reducer);
      }
...
(function () {
  function e(t, r, n) {
    var l = Lt(t + "/fulfilled", function (u, f, d, p) {
      ...
      c = Lt(t + "/rejected", function (u, f, d, p, g) {
        return { payload: p, error: ((n && n.serializeError) || F0)(u || "Rejected"), meta: Pi(Rt({}, g || {}), { arg: d, requestId: f, rejectedWithValue: !!p, requestStatus: "rejected", aborted: (u == null ? void 0 : u.name) === "AbortError", condition: (u == null ? void 0 : u.name) === "ConditionError" }) };
      }),
      s =
    ...
    function a(u) {
      return function (f, d, p) {
        var g = n != null && n.idGenerator ? n.idGenerator(u) : $0(),
          x = new s(),
          v;
        function w(m) {
          (v = m), x.abort();
        ...
        var h = (function () {
          return k0(this, null, function () {
            ...
            return y0(this, function (D) {
              switch (D.label) {
                case 0:
                  return D.trys.push([0, 4, , 5]), (C = (m = n == null ? void 0 : n.condition) == null ? void 0 : m.call(n, u, { getState: d, extra: p })), U0(C) ? [4, C] : [3, 2];
                case 1:
                  (C = D.sent()), (D.label = 2);
                case 2:
                  ...
                  return (
                    (P = new Promise(function (T, oe) {
                      return x.signal.addEventListener("abort", function () {
                        return oe({ name: "AbortError", message: v || "Aborted" });
                      });
                    })),
                    f(i(g, u, (y = n == null ? void 0 : n.getPendingMeta) == null ? void 0 : y.call(n, { requestId: g, arg: u }, { getState: d, extra: p }))),
                    [
                      4,
                      Promise.race([
                        P,
                        Promise.resolve(
                          ...
                          return T instanceof Cu ? l(T.payload, g, u, T.meta) : l(T, g, u);
                        }),
                      ]),
                    ]
                  );
                case 3:
                  return (S = D.sent()), [3, 5];
                case 4:
                  return (N = D.sent()), (S = N instanceof _i ? c(null, g, u, N.payload, N.meta) : c(N, g, u)), [3, 5];
                case 5:
...
const Op = bp({
  ...
  Bt = () => {
    ...
    const [r, n] = j.useState(!1),
      ...
      i = async () => {
        try {
          const s = await (await fetch("http://localhost:3000/blogsAPI/signout", { method: "POST", credentials: "include", headers: { "Content-Type": "application/json", authorization: t.token } })).json();
    ...
    return o.jsx("header", {
      ...
      children: o.jsxs("div", {
        ...
        children: [
          o.jsx(Ye, { to: "/", children: o.jsxs("h1", { className: "flex items-start space-x-1", children: [o.jsx("span", { className: "text-black text-xl font-bold ", children: "Daily" }), o.jsx("span", { className: "text-orange-600 text-xl font-bold ", children: "Good News" })] }) }),
          o.jsxs("nav", { className: "lg:flex hidden items-center space-x-30", children: [t.isLoggedIn && o.jsxs("p", { className: "mr-5", children: ["Hello ", t.firstName, "!"] }), t.isLoggedIn && o.jsx(Ye, { to: "/update", children: o.jsx(ur, { text: "Update Profile", color: "emerald" }) }), !t.isLoggedIn && o.jsx(Ye, { to: "/login", children: o.jsx(ur, { text: "Login", hoverBG: "emerald" }) }), !t.isLoggedIn && o.jsx(Ye, { to: "/signup", children: o.jsx(ur, { text: "Sign Up", color: "emerald" }) }), t.isLoggedIn && o.jsx(Ye, { onClick: i, children: o.jsx(Oc, { text: "Logout", color: "orange" }) })] }),
          ...
          r &&
            o.jsx("nav", {
              ...
              children: o.jsxs("ul", {
                ...
                children: [o.jsx(tn, { onClick: l, children: t.isLoggedIn && o.jsxs("p", { className: " text-center", children: ["Hello ", t.firstName, "!"] }) }), t.isLoggedIn && o.jsx(tn, { onClick: l, children: o.jsx(Ye, { to: "/update", children: o.jsx(ur, { text: "Update Profile", color: "emerald" }) }) }), !t.isLoggedIn && o.jsx(tn, { onClick: l, children: o.jsx(Ye, { to: "/login", children: o.jsx(ur, { text: "Login", hoverBG: "emerald" }) }) }), !t.isLoggedIn && o.jsx(tn, { onClick: l, children: o.jsx(Ye, { to: "/signup", children: o.jsx(ur, { text: "Sign Up", color: "emerald" }) }) }), t.isLoggedIn && o.jsx(tn, { onClick: l, children: o.jsx(Ye, { onClick: i, children: o.jsx(Oc, { text: "Logout", color: "orange" }) }) })],
              }),
            }),
        ],
      }),
...
function bi() {
  ...
  const c = async () => {
    try {
      const s = await fetch("http://localhost:3000/blogsAPI/posts", { method: "GET", headers: { "Content-Type": "application/json" } }),
        a = await s.json();
      if (!s.ok) {
      ...
      children: [
        ...
        o.jsxs("div", {
          ...
          children: [
            ...
            o.jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2  gap-4", children: e.length > 0 ? e.map((s) => o.jsx(Ye, { to: `/posts/${s._id}`, children: o.jsxs("div", { className: "bg-white p-4 rounded shadow", children: [o.jsx("h2", { className: "text-xl text-center font-bold mb-2", children: s.title }), o.jsxs("p", { className: "text-center text-sm", children: ["Posted By: ", s.author.firstName, " ", s.author.lastName, " , On: ", s.timestamp ? new Date(s.timestamp).toISOString().split("T")[0] : "N/A"] }), o.jsx("div", { className: "mt-2   ", children: o.jsx("div", { className: "text    ", dangerouslySetInnerHTML: { __html: s.text } }) })] }) }, s._id)) : o.jsx("h1", { className: "text-3xl text-center font-bold mb-4", children: "No News Published Yet!" }) }),
          ],
        }),
        o.jsx(Wt, {}),
      ],
...
function W0({ fetchComments: e }) {
  ...
  const t = Qe((f) => f.auth),
    ...
    u = async (f) => {
      try {
        const d = await fetch("http://localhost:3000/blogsAPI/comments", { method: "POST", headers: { "Content-Type": "application/json", authorization: t.token }, body: JSON.stringify(f) });
        if (!d.ok) {
...
function H0() {
  ...
  const [i, c] = j.useState([]),
    ...
    p = async () => {
      try {
        const x = await fetch("http://localhost:3000/blogsAPI/posts/" + d, { method: "GET", headers: { "Content-Type": "application/json" } }),
          v = await x.json();
        if ((console.log(v), !x.ok)) {
          l(v.message);
          return;
        }
        if (v.message) {
    ...
    g = async () => {
      try {
        const x = await fetch("http://localhost:3000/blogsAPI/comments/" + d, { method: "GET", headers: { "Content-Type": "application/json", authorization: e.token } }),
          v = await x.json();
        if (!x.ok) {
          console.log(v.message), f(v.message);
          return;
        }
        if (v.message) {
          c(v.message);
  ...
  return (
    ...
    o.jsxs(o.Fragment, {
      children: [
        o.jsx(Bt, {}),
        o.jsxs("div", {
          className: "container min-h-[800px] mx-auto mt-8 mb-16  rounded shadow",
          children: [n && o.jsx("h3", { className: "response text-center text-orange-500 text-xl font-bold container mx-auto ", children: n }), o.jsx("div", { className: "grid grid-cols-1  gap-4  ", children: t && o.jsxs("div", { className: "bg-white p-4 ", children: [o.jsx("h2", { className: "text-xl font-bold mb-2", children: t.title }), t.author && o.jsxs("p", { className: " text-sm", children: ["Posted By: ", t.author.firstName, " ", t.author.lastName, " , On: ", t.timestamp ? new Date(t.timestamp).toISOString().split("T")[0] : "N/A"] }), o.jsx("div", { className: "mt-2   ", children: o.jsx("div", { className: "text col-span-3  ", dangerouslySetInnerHTML: { __html: t.text } }) })] }) }), t && o.jsx(V0, { responseCommentsFromBackEnd: u, post: s }), t && o.jsx(W0, { fetchComments: g })],
        }),
        o.jsx(Wt, {}),
      ],
    })
...
function Oi() {
  ...
  const [n, l] = j.useState({ email: "", password: "" }),
    [i, c] = j.useState(null),
    s = (f) => {
    ...
    u = async (f) => {
      try {
        const d = await fetch("http://localhost:3000/blogsAPI/signin", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(f), credentials: "include" });
        if (!d.ok) {
          const x = await d.json();
          c(x.message);
          return;
...
function Q0() {
  ...
  const [r, n] = j.useState({ firstName: "", lastName: "", email: "", password: "", rpassword: "" }),
    [l, i] = j.useState(!1),
    [c, s] = j.useState(null),
    a = (d) => {
      const { name: p, value: g } = d.target;
      n({ ...r, [p]: g });
    },
    u = (d) => {
    ...
    f = async (d) => {
      try {
        const p = await fetch("http://localhost:3000/blogsAPI/signup", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(d) });
        if (!p.ok) {
        ...
        console.log("Response from backend:", g.message), s(g.message);
        const x = setTimeout(() => {
          e("/login");
        }, 2500);
...
function G0() {
  const e = tt(),
    t = Qe((x) => x.auth),
    r = Qn(),
    [n, l] = j.useState({ firstName: "", lastName: "", email: "", password: "", rpassword: "" }),
    [i, c] = j.useState(!1),
    [s, a] = j.useState(null),
    u = (x) => {
      const { name: v, value: w } = x.target;
      l({ ...n, [v]: w });
    },
    f = async () => {
      if (confirm("Do you want to delete your account?"))
        try {
          const v = await fetch("http://localhost:3000/blogsAPI/delete", { method: "DELETE", credentials: "include", headers: { "Content-Type": "application/json", authorization: t.token } }),
            w = await v.json();
          if ((a(w.message), !v.ok)) return;
          w.delete && (localStorage.removeItem("token"), r(St.logout()), e("/"));
        } catch (v) {
    ...
    d = async () => {
      try {
        const x = await fetch("http://localhost:3000/blogsAPI/update", { method: "GET", credentials: "include", headers: { "Content-Type": "application/json", authorization: t.token } }),
          v = await x.json();
        if (!x.ok) {
          console.log(v.message);
          return;
        }
        l({ firstName: v.firstName, lastName: v.lastName, email: v.email, password: "", rpassword: "" });
      } catch (x) {
        console.log(x);
      }
    };
  ...
  const p = (x) => {
      x.preventDefault(), g(n);
    },
    g = async (x) => {
      try {
        const v = await fetch("http://localhost:3000/blogsAPI/update", { method: "PUT", headers: { "Content-Type": "application/json", authorization: t.token }, body: JSON.stringify(x) });
        if (!v.ok) {
        ...
        a(w.message), localStorage.removeItem("token"), localStorage.removeItem("expire"), r(St.logout());
        const h = setTimeout(() => {
          e("/");
        }, 1500);
        return () => clearTimeout(h);
      } catch (v) {
        a("Error sending data to backend: " + v.message);
      }
    };
  return (
    t.isLoggedIn &&
...
var k = Tp.exports,
  ...
  i2 = function (e) {
    var t = {},
      ...
      n = function (c, s, a) {
        var u = function (m) {
          return a !== void 0 ? a(m) : console.error(m);
        };
        if (c.length === 0) {
        ...
        for (
          ...
          var v = x[g],
            w = t[v.src];
          if (w) w.done ? p(v.src, w.error) : w.handlers.push(p);
          else {
            var h = zp("tiny-");
            (t[v.src] = { id: h, src: v.src, done: !1, error: null, handlers: [p] }), o2(e, $c({ id: h }, v), r);
          }
        }
      },
      l = function () {
            ...
            var g = no(no({}, c.props.init), {
              ...
              init_instance_callback: function (x) {
                var v,
                  w,
                  h = c.getInitialValue();
                (c.currentContent = (v = c.currentContent) !== null && v !== void 0 ? v : x.getContent()), c.currentContent !== h && ((c.currentContent = h), x.setContent(h), x.undoManager.clear(), x.undoManager.add(), x.setDirty(!1));
                var m = (w = c.props.disabled) !== null && w !== void 0 ? w : !1;
                Ru(c.editor, m ? "readonly" : "design"), c.props.init && Ti(c.props.init.init_instance_callback) && c.props.init.init_instance_callback(x);
              },
            });
            c.inline || (d.style.visibility = ""), Ou(d) && (d.value = c.getInitialValue()), p.init(g);
          }
        }),
        (c.id = c.props.id || zp("tiny-react")),
        (c.elementRef = j.createRef()),
    ...
    return (
      ...
      (t.prototype.renderInline = function () {
        var r = this.props.tagName,
          n = r === void 0 ? "div" : r;
        return j.createElement(n, { ref: this.elementRef, id: this.id });
      }),
      (t.prototype.renderIframe = function () {
        return j.createElement("textarea", { ref: this.elementRef, style: { visibility: "hidden" }, name: this.props.textareaName, id: this.id });
      }),
...
function f2() {
  const e = tt(),
    t = Qe((g) => g.auth),
    [r, n] = j.useState({ title: "", published: "draft" }),
    [l, i] = j.useState(null),
    c = (g) => {
      const { name: x, value: v } = g.target;
      n({ ...r, [x]: v });
    },
    ...
    d = (g) => {
      g.preventDefault(), p({ title: r.title, text: a, published: r.published });
    },
    p = async (g) => {
      try {
        const x = await fetch("http://localhost:3000/blogsAPI/posts", { method: "POST", headers: { "Content-Type": "application/json", authorization: t.token }, body: JSON.stringify(g) });
        if (!x.ok) {
...
function d2() {
  const e = tt(),
    t = Qe((w) => w.auth);
  Qn();
  const [r, n] = j.useState({ title: "", published: "draft" }),
    [l, i] = j.useState(""),
    [c, s] = j.useState(""),
    a = (w, h) => {
      s(w), console.log(c);
    ...
    [u, f] = j.useState(null),
    d = (w) => {
      const { name: h, value: m } = w.target;
      n({ ...r, [h]: m });
    },
    { postId: p } = Ls(),
    g = async () => {
      try {
        const w = await fetch("http://localhost:3000/blogsAPI/posts/" + p, { method: "GET", headers: { "Content-Type": "application/json", authorization: t.token } }),
          h = await w.json();
        if ((console.log(h), !w.ok)) {
          console.log(h.message);
          return;
        }
        n({ title: h.title, published: h.published }), i(h.text), s(h.text);
      } catch (w) {
        console.log(w);
      }
    };
  ...
  const x = (w) => {
      w.preventDefault(), v({ title: r.title, text: c, published: r.published });
    },
    v = async (w) => {
      console.log(w);
      try {
        const h = await fetch("http://localhost:3000/blogsAPI/posts/" + p, { method: "PUT", headers: { "Content-Type": "application/json", authorization: t.token }, body: JSON.stringify(w) });
        if (!h.ok) {
        ...
        f("Error sending data to backend: " + h.message);
      }
    };
  return o.jsxs(o.Fragment, {
    children: [
...
const p2 = () => {
  const e = Qe((t) => t.auth.isLoggedIn);
  return o.jsx(ny, { children: o.jsxs(Xx, { children: [o.jsx(Ge, { path: "/", element: o.jsx(bi, {}) }), o.jsx(Ge, { path: "/posts/:postId", element: o.jsx(H0, {}) }), o.jsx(Ge, { path: "/login", element: o.jsx(Oi, {}) }), o.jsx(Ge, { path: "/signup", element: o.jsx(Q0, {}) }), o.jsx(Ge, { path: "/update", element: e ? o.jsx(G0, {}) : o.jsx(bi, {}) }), o.jsx(Ge, { path: "/new_post", element: e ? o.jsx(f2, {}) : o.jsx(Oi, {}) }), o.jsx(Ge, { path: "/editpost/:postId", element: e ? o.jsx(d2, {}) : o.jsx(Oi, {}) }), o.jsx(Ge, { path: "/products/:productId", element: o.jsx(bi, {}) }), o.jsx(Ge, { path: "*", element: o.jsx(K0, {}) })] }) });
};
function m2() {
  const e = Qn(),
    t = Qe((l) => l.auth),
    r = async () => {
      if (localStorage.getItem("token"))
        try {
          const i = await (await fetch("http://localhost:3000/blogsAPI/validateLoginStatus", { method: "POST", headers: { "Content-Type": "application/json", authorization: localStorage.getItem("token") } })).json();
  ...
  const n = async () => {
    ...
    if ((console.log("JWT token will get refreshed in " + (i - 1) + "minutes."), t.token && i < 1)) {
      ...
      try {
        const s = await (await fetch("http://localhost:3000/blogsAPI/refresh", { method: "GET", headers: { "Content-Type": "application/json" }, credentials: "include" })).json();
